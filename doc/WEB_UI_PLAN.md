...
| P3-09 | ⏯️ DEFERRED | `ShiftRotateAnimation.svelte` — 8-cell bit strip showing AC bits flowing into/out of carry for `SHR/SHL/ROR/ROL` | Deferred to Phase 4 (lands with P4-02 Ahmes). Ahmes-specific — no other machine consumes it |
